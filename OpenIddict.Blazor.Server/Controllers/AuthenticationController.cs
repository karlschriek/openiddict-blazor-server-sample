...
public class AuthenticationController : Controller
{
    ...
    //
    // public AuthenticationController(ICacheService cache)
    // {
    //     _cache = cache;
    // }
    ...
    public async Task<ActionResult> LogInCallback()
    {
        ...
        // store it in cache
        // TODO only set this if provider from specific AzureAD ClientID
        var roles = JsonSerializer.Serialize(result.Principal.GetClaims("roles").ToList());
       // _cache.Set(result.Principal.GetClaim(ClaimTypes.Email), roles);
